...
com_pos_IK_data = np.loadtxt('com_position_bound.dat')
lin_mom_IK_data = np.loadtxt('linear_momentum_bound.dat')
ang_mom_IK_data = np.loadtxt('angular_momentum_bound.dat')
