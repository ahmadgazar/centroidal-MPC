from src.utils import construct_friction_pyramid_constraint_matrix
            ...
            if contact_trajectory[contact][time_idx].ACTIVE:
                ...
                for com_dir, optimizer_object in enumerate (optimizer_objects):
                    ...
                    if com_dir == 0:
                        ...
                        l_x[time_idx] =  -epsilon - p[com_dir]
                        u_x[time_idx] =   epsilon - p[com_dir]
                    # y-direction
                    elif com_dir == 1:
                        Aineq_y[time_idx, optimizer_idx] = -1.
                        l_y[time_idx] = -epsilon - p[com_dir]
                        u_y[time_idx] =  epsilon - p[com_dir]
                    # z-direction
                    elif com_dir == 2:
